                ...
                {filteredCustomers.map((customer) => (
                    ...
                    >
                        ...
                        <div className="flex items-start gap-3 mb-3">
                            <div className={`w-10 h-10 rounded-full ${customer.avatarColor} flex items-center justify-center text-white font-bold text-sm`}>
                                {customer.initials}
                            </div>
                            <div>
                        ...
                        <div className="flex justify-between items-end">
                            <div>
                                ...
                                <p className="text-sm font-bold text-[#0f172a]">SZL {customer.totalSpent.toLocaleString()}</p>
                            </div>
                            <div className="text-right">
                                <p className="text-[10px] text-[#64748b] mb-1">Last purchase: {customer.lastPurchaseDate}</p>
                                <div className="flex gap-1 justify-end">
                                    {customer.tags.map(tag => (
                                        <span key={tag} className="px-1.5 py-0.5 bg-slate-100 rounded text-[10px] font-medium text-[#64748b]">
                                            {tag}
                                        </span>
                                    ))}
                                </div>
