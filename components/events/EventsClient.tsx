...
import { EventsHeader } from "@/components/shared/events/EventsHeader";
import { EventsFilters } from "@/components/shared/events/EventsFilters";
import { EventsGrid } from "@/components/shared/events/EventsGrid";
import { EventsSidebar } from "@/components/shared/events/EventsSidebar";
...
export default function EventsClient({ initialEvents }: EventsClientProps) {
  ...
  const filteredEvents = events.filter((event) => {
    ...
    const matchesStatus =
      filterStatus === "All Events" || event.status === filterStatus;
