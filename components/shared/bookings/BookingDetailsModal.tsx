                ...
                >
                    ...
                    <div className="p-6 space-y-6">
                        ...
                        <div className="flex items-center gap-4 bg-muted/50 p-4 rounded-xl border border-border">
                            <div className={`w-12 h-12 rounded-full flex items-center justify-center ${booking.status === "Confirmed" ? "bg-success/10 text-success" :
                            ...
                            <div>
                                <div className="font-semibold text-foreground">{booking.status}</div>
                            ...
                            <div className="space-y-3">
                                <div className="flex justify-between items-center py-2 border-b border-border">
                                    <div className="text-sm">
                                        <span className="font-medium text-foreground">{booking.type} Ticket</span>
                                        <span className="text-muted-foreground"> x {booking.qty}</span>
                                    </div>
                                    <div className="font-medium text-foreground">SZL {booking.amount}</div>
                                </div>
                                <div className="flex justify-between items-center pt-2">
                                    <div className="font-bold text-foreground">Total Paid</div>
                                    <div className="font-bold text-xl text-success">SZL {booking.amount}</div>
                                </div>
                    ...
                    <div className="p-4 bg-muted/50 border-t border-border flex gap-3">
                        <button className="flex-1 flex items-center justify-center gap-2 px-4 py-2.5 bg-card border border-border rounded-lg text-sm font-medium text-foreground hover:bg-muted transition-colors">
                        ...
                        {booking.status !== "Cancelled" && (
                            <button className="flex items-center justify-center gap-2 px-4 py-2.5 bg-error/10 border border-error/20 rounded-lg text-sm font-medium text-error hover:bg-error/20 transition-colors">
