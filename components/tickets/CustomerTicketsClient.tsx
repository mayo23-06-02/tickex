    ...
    return (
        <DashboardLayout>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                {tickets.length > 0 ? (
                    tickets.map((ticket) => (
                        <div key={ticket.id} className="bg-white rounded-2xl border border-slate-200 overflow-hidden hover:shadow-lg transition-all">
                            ...
                            <div className="p-6">
                                ...
                                <h3 className="text-lg font-bold text-[#0f172a] mb-1">{ticket.eventName}</h3>
                                <p className="text-sm text-[#1DB954] font-medium mb-4">{ticket.ticketType}</p>
                                ...
                                <div className="pt-6 border-t border-dashed border-slate-200 flex flex-col items-center gap-3">
                                    ...
                                    <p className="text-xs font-mono text-slate-400 tracking-widest">{ticket.code}</p>
                                </div>
                            </div>
                        </div>
                    ))
                    ...
                    <div className="col-span-full py-20 text-center">
                        ...
                        <h3 className="text-lg font-bold text-[#0f172a] mb-2">No tickets yet</h3>
                        <p className="text-slate-500 mb-6">You haven't purchased any tickets yet.</p>
                        <a href="/" className="px-6 py-2.5 bg-[#1DB954] hover:bg-[#1ed760] text-white rounded-lg font-medium transition-colors">
                            Browse Events
                        </a>
                    </div>
                )}
