        ...
        <DashboardLayout>
            <div className="space-y-6">
                ...
                <div className="flex justify-between items-start">
                    <div>
                        <h1 className="text-2xl font-bold text-[#0f172a]">Event Timeline</h1>
                        <p className="text-[#64748b]">Manage milestones and track progress for Summer Music Festival 2025</p>
                    </div>
